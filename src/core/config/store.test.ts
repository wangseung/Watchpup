...
describe('ConfigStore', () => {
  it('applies defaults and persists updates', () => {
    ...
    expect(s1.get().showActivityHud).toBe(true)
    s1.update({ mySlackUserId: 'U123', model: 'sonnet', petSizePercent: 150, bubbleSizePercent: 80, hudSizePercent: 70, showActivityHud: false })
